...
namespace Game
{
    public partial class PlayDurak : Form
    {
        ...
        public void GenerateMainMenu()
        {
            ...
            lblTitle.Location = new Point(300, 150);
            lblTitle.AutoSize = true;
            mainMenuPanel.Controls.Add(lblTitle);

            //Instantiate the controls
            mainMenuPanel.Controls.AddRange(GetButtonMenu(buttonText, 
        ...
        public static Button[] GetButtonMenu(string[] buttonText, Size buttonSize, Point buttonLocation, int verticalSpacing=25, int horizontalSpacing=25, Font font = default(Font))
        {
